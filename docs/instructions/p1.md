...
| 1.0 | 07/17/23 | Initial draft | [Amilcar Nditifei](mailto:anditife@uncc.edu) | Amilcar Nditifei](mailto:anditife@uncc.edu) |
...
**Type:** Functional
**Priority:** 4
**Rationale:** A movie ticket booking application needs a database of moovies to have tickets for.
...
Class format: online class format makes it difficult to collaborate with team members.
Coding languages: Students might be exposed for the first time to Python, HTML, CSS, JavaScript so the quality of work in such limited timeline might not be best.
...
- **ID:** UC-3
  - **Description:** A user of the application searches for and finds the latest Spiderman movie which plays at the Carolina Mall place at 5 45 pm.
  - **Actors:** The user of the application, the application itself and the third-party software that controls the movie theater databases.
...
- **ID:**  UC-4
  - **Description:** A user of the application searches for and finds the latest Spiderman movie which plays at the Carolina Mall place at 5 45 pm on Saturday then book ticket(s).
  - **Actors:** The user of the application, the application itself and the third-party software that controls the movie theater databases.
...
- **ID:** US-3
  ...
  - **Description:** Application should be easy to navigate.

- **ID:** US-4
  - **Type of User:** Admin
  - **Description:** Since users will constantly query the databases that support the application, coding should be done to protect against SQL injections.
