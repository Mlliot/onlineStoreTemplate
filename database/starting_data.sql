...
VALUES ('Pulp Fiction', 'by Quentin Tarantino', 10.00, 10, 'static/images/pulp_fiction.jpg', 'Crime');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Oppenheimer', 'by Cristopher Nolan', 15.00, 10, 'static/images/oppenheimer.jpg', 'Drama');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Scream', 'by Wes Craven', 6.00, 5, 'static/images/scream.jpg', 'Horror');
...
INSERT into `customers` (`user_name`, `email`, `first_name`, `last_name`)
...
VALUES ('XYY1', 'top gun', '120 minutes', '2023-08-10');
